...
>
class fulcrum_sparse_encoder : public
	...
	kodo_fulcrum::fulcrum_sparse_shallow_full_vector_encoder<fifi::binary, Features>,
	...
	// Payload Codec API
		...
		//systematic encoder and decoder is defined in this layer
	    kodo_rlnc::shallow_full_vector_encoder<fifi::binary, Features>,
	    // Coefficient Generator API
	    kodo_core::sparse_generator_layers::type<Features,
	    // Codec API
	    kodo_core::common_encoder_layers<Features,
	    // Coefficient Storage API
	    kodo_core::coefficient_value_access<
...
{
public:
    using factory = kodo_core::pool_factory<fulcrum_sparse_encoder>;
};
}
